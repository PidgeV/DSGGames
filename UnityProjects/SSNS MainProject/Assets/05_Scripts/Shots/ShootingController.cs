...
public class ShootingController : MonoBehaviour
{
    ...
    void Start()
    {
        rbShooter = GetComponent<Rigidbody>();
        rbTarget = target.GetComponent<Rigidbody>();
        shotSpeed = bulletPrefab.GetComponent<BulletScript>().speed;
    ...
    IEnumerator ShootWithInterval()
    {
        while (true)
        {
            ...
            //velocities
            Vector3 shooterVelocity = rbShooter ? rbShooter.velocity : Vector3.zero;
            ...
            //Instantiate bullet and look towards target
            GameObject bullet = Instantiate(bulletPrefab);
            bullet.transform.position = transform.position;
            bullet.transform.LookAt(interceptPoint, Vector3.up);
        }
    }
